...
public class MinHeap {
    ...
    public MinHeapForPlaylists[] heapOfEachPlaylist;

    // Constructor
    public MinHeap(int maxsize, int category) {
    ...
    public void insert(Song element) {
        ...
        if(heapOfEachPlaylist[element.inWhichPlaylist] == null){
            heapOfEachPlaylist[element.inWhichPlaylist] = new MinHeapForPlaylists(100,category);
            heapOfEachPlaylist[element.inWhichPlaylist].insert(element);
        } else{
            heapOfEachPlaylist[element.inWhichPlaylist].insert(element);
        }
    }
    ...
    public Song extractMin() {
        ...
        //System.out.println(this.peek().songId);
        ...
        if (size == 0) {
            ...
            heap[1] = null;
            size--;
            heapOfEachPlaylist[popped.inWhichPlaylist].remove(popped);
        ...
        if(size >= 300){
            ...
            //System.out.println(heap[300].songId);
        }

        Song popped = heap[1];
        heap[1] = heap[size--];

        //System.out.println(heap[1].songId);
    ...
    public boolean remove(Song element) {
        ...
        heapOfEachPlaylist[element.inWhichPlaylist].remove(element);
